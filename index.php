                ...
                <div class="carousel-inner slider">
                    <?php if(get_theme_mod('ktb-slider-image0') != null): ?>
                        <div class="carousel-item active">
                            <img class="d-block w-100" src="<?php echo wp_get_attachment_url(get_theme_mod('ktb-slider-image0')); ?>" alt="Bild 1">
                        </div>
                    <?php endif; ?>
                    <?php if(get_theme_mod('ktb-slider-image1') != null): ?>
                        <div class="carousel-item">
                            <img class="d-block w-100" src="<?php echo wp_get_attachment_url(get_theme_mod('ktb-slider-image1')); ?>" alt="Bild 2">
                        </div>
                    <?php endif; ?>
                    <?php if(get_theme_mod('ktb-slider-image2') != null): ?>
                        <div class="carousel-item">
                            <img class="d-block w-100" src="<?php echo wp_get_attachment_url(get_theme_mod('ktb-slider-image2')); ?>" alt="Bild 3">
                        </div>
                    <?php endif; ?>
                    <?php if(get_theme_mod('ktb-slider-image3') != null): ?>
                        <div class="carousel-item">
                            <img class="d-block w-100" src="<?php echo wp_get_attachment_url(get_theme_mod('ktb-slider-image3')); ?>" alt="Bild 4">
                        </div>
                    <?php endif; ?>
                    <?php if(get_theme_mod('ktb-slider-image4') != null): ?>
                        <div class="carousel-item">
                            <img class="d-block w-100" src="<?php echo wp_get_attachment_url(get_theme_mod('ktb-slider-image4')); ?>" alt="Bild 5">
                        </div>
                    <?php endif; ?>
